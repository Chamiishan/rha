...
public class GooglePlacesAutocompleteActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    private static final String API_KEY = "AIzaSyDMHcIqvpWK9tE9AgQ3PVeYUn20eXJx54Y";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompView.setAdapter(new GooglePlacesAutocompleteAdapter(this, R.layout.placelist_item));
